...
class EntityReferenceProcessorTest {
    ...
    private final de.paladinsinn.torg.codex.data.markup.EntityReferenceProcessor
        processor = new de.paladinsinn.torg.codex.data.markup.EntityReferenceProcessor();
