...
public interface ShardRepository extends JpaRepository<Shard, UUID> {
    ...
    @Query("SELECT s FROM Shard s WHERE :cosm MEMBER OF s.cosms")
    List<Shard> findByCosm(@Param("cosm") String cosm);

    List<Shard> findByClearanceLevel(ClearanceLevel clearanceLevel);
