...
== Decision
API versioning will be implemented using media-type versioning in the HTTP header (e.g. `Content-Type: application/vnd.1.3.6.1.4.1.33132.1.v1+json`).
...
The format is `´application/vnd.1.3.6.1.4.1.<PEN>.1+<FORMAT>`.
