...
|* The software offers a reference for TORG.
...
---_ Provide a reference for TORG players and GMs (FS01)
-- Compatibility (CO)
---_ Compatible with discord (CO01)
---_ Compatible with VTT systems (CO02)
-- Security (SE)
---_ Data Retention TTL (SE01)
---_ Attribute based access control (ABAC) (SE02)
